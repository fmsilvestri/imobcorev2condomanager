...
export default function SindicoHome({
  ...
  const mods: ModItem[] = [
    ...
    { icon:"📄", title:"Documentos",   screen:"documentos",   sub:"Licenças & Docs",                                                      hasDot:false,           bg:"linear-gradient(145deg,#d97706,#f59e0b,#fcd34d)", glow:"rgba(245,158,11,0.45)",  text:"#fffbeb", badge:"rgba(0,0,0,0.15)" },
